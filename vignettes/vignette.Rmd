...
```
We can quickly examing the attached enrichment scores using the visualization/workflow we prefer - here we will use just `FeaturePlot()' from the Seurat R package. 
```{r}
