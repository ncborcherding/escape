...
dittoHeatmap(sce, genes = NULL, 
             metas = c("HALLMARK_IL2_STAT5_SIGNALING_UCell", 
...
```{r}
multi_dittoPlot(sce, 
                vars = c("HALLMARK_IL2_STAT5_SIGNALING_UCell", 
                       "HALLMARK_IL6_JAK_STAT3_SIGNALING_UCell", 
                       "HALLMARK_INFLAMMATORY_RESPONSE_UCell"), 
                group.by = "groups", 
...
```{r}
dittoScatterHex(sce, x.var = "HALLMARK_IL2_STAT5_SIGNALING_UCell", 
                    y.var = "HALLMARK_IL6_JAK_STAT3_SIGNALING_UCell", 
                    do.contour = TRUE) + 
...
```{r}
splitEnrichment(ES2, split = "groups", 
                gene.set = "HALLMARK_IL2_STAT5_SIGNALING")
splitEnrichment(ES2, x.axis = "cluster", 
                split = "groups", 
                gene.set = "HALLMARK_IL2_STAT5_SIGNALING")
```
...
```{r}
PCA <- performPCA(enriched = ES2, 
                  gene.sets = names(GS.hallmark), 
                  groups = c("groups", "cluster"))
```
